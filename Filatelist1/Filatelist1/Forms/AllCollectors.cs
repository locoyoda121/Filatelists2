...
namespace Filatelist1
{
    public partial class AllCollectors : Form
    {
        ...
        public void FillGridView()
        {
            ...
            {
                collectorGridView.Rows.Add(collector.Id, collector.Name, collector.Country, collector.Phone, collector.Listmarks.Count);
            }
        ...
        private void FillGridViewSearch(IEnumerable<Collector> a)
        {
            ...
            {
                collectorGridView.Rows.Add(coll.Id, coll.Name, coll.Country, coll.Phone, coll.Listmarks.Count);
            }
        }
